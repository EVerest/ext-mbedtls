                                         ...
                                         size_t len )
{
    ...
    MBEDTLS_SSL_DEBUG_MSG( 3, ( "parse trusted ca key extension" ) );
    ...
    while( trusted_auth_list_size >  0 )
    {
             ...
             ( ( trusted_auth_size - 1 ) > 20) )
        {
            ...
            for( selected_id = 0; own_trusted_auth != NULL && own_key_cert != NULL;
                 selected_id++ )
            {
                /* Check id */
                if( identifier_type == own_trusted_auth->id_type &&
                    ( trusted_auth_size - 1 ) == own_trusted_auth->len &&
                    memcmp( own_trusted_auth->id, p,  trusted_auth_size ) == 0 )
                {
    ...
    defined(MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED)
          ...
          MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED */
            ...
            case MBEDTLS_TLS_EXT_TRUSTED_CA_KEYS:
                MBEDTLS_SSL_DEBUG_MSG( 3, ( "found TrustedCAKeys extension" ) );
