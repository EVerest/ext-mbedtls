...
run_test    "Trusted CA keys: server default" \
            "$P_SRV debug_level=3" \
            "$P_CLI debug_level=3 trusted_id_type=0" \
            0 \
            -S "selected trusted id #1" \
            -S "no appropriate certificate chain found" \
            -C "found trusted_ca_keys extension"

requires_config_enabled MBEDTLS_SSL_TRUSTED_CA_KEYS
run_test    "Trusted CA keys: pre agreed" \
            "$P_SRV debug_level=3 trusted_id_type=0" \
            "$P_CLI debug_level=3 trusted_id_type=0" \
            0 \
            -s "selected trusted id #1" \
            -S "no appropriate certificate chain found" \
...
run_test    "Trusted CA keys: same trusted ids" \
            "$P_SRV debug_level=3 trusted_id_type=3 trusted_id=01234567890123456789" \
            "$P_CLI debug_level=3 trusted_id_type=3 trusted_id=01234567890123456789" \
            0 \
            -s "selected trusted id #1" \
            -S "no appropriate certificate chain found" \
            -c "found trusted_ca_keys extension"
...
run_test    "Trusted CA keys: different trusted ids" \
            "$P_SRV debug_level=3 trusted_id_type=3 trusted_id=01234567890123456789" \
            "$P_CLI debug_level=3 trusted_id_type=3 trusted_id=11234567890123456789" \
            0 \
            -s "no appropriate certificate chain found" \
            -S "selected trusted id #1" \
            -c "found trusted_ca_keys extension"
...
run_test    "Trusted CA keys: different trusted id types" \
            "$P_SRV debug_level=3 trusted_id_type=3 trusted_id=01234567890123456789" \
            "$P_CLI debug_level=3 trusted_id_type=2 trusted_id=01234567890123456789" \
            0 \
            -s "no appropriate certificate chain found" \
            -S "selected trusted id #1" \
            -c "found trusted_ca_keys extension"
...
run_test    "Trusted CA keys: list of trusted ids" \
            "$P_SRV debug_level=3 trusted_id_type=2 trusted_id=11234567890123456789" \
            "$P_CLI debug_level=3 trusted_id_type=2 trusted_id=01234567890123456789,11234567890123456789" \
            0 \
            -s "selected trusted id #1" \
            -S "no appropriate certificate chain found" \
            -c "found trusted_ca_keys extension"
...
run_test    "Trusted CA keys: list of different trusted ids" \
            "$P_SRV debug_level=3 trusted_id_type=2 trusted_id=11234567890123456789" \
            "$P_CLI debug_level=3 trusted_id_type=2 trusted_id=01234567890123456789,02234567890123456789" \
            0 \
            -s "no appropriate certificate chain found" \
            -S "selected trusted id #1"
